...
export default function BodyPartModal({ visible, onCancel, onFinish, loading, initialValues }) {
    ...
    return (
        <Modal title={initialValues ? "Edit Bagian Tubuh" : "Tambah Bagian Tubuh"} open={visible} onCancel={onCancel} footer={null} destroyOnHidden>
            <Form form={form} layout="vertical" onFinish={onFinish} initialValues={{ is_active: true }}>
                <Form.Item label="Nama Bagian Tubuh" name="name" rules={[{ required: true, message: "Masukan nama bagian tubuh!" }]}>
                    <Input placeholder="Contoh: Kepala / Tangan Kanan" />
                </Form.Item>
