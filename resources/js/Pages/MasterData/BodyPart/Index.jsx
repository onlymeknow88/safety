    ...
    return (
        <DashboardLayout title="Master Data Bagian Tubuh">
                ...
                <Row gutter={[16, 16]} align="middle" style={{ marginBottom: 24 }}>
                    <Col xs={24} md={12}>
                        <h2 style={{ margin: 0, fontWeight: 700, fontSize: isMobile ? "20px" : "24px", color: isDarkMode ? "#fff" : "#1e293b" }}>
                            Master Data Bagian Tubuh
                        </h2>
                        <p style={{ margin: 0, color: "#64748b", fontSize: isMobile ? "13px" : "14px" }}>
                            Kelola data bagian tubuh dan klasifikasinya.
                        </p>
                    </Col>
            ...
            <DeleteConfirmModal 
                ...
                title="Hapus Bagian Tubuh" 
                description={`Apakah Anda yakin ingin menghapus "${itemToDelete?.name}"?`} 
                loading={loading} 
            />
        </DashboardLayout>
    );
