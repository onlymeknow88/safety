...
export default function usePersonalFactor() {
    const { notification } = App.useApp();
    const [getRequest, getFeedback] = useGet();
    const [postRequest] = usePost("personal-factor");
    const [putRequest] = usePut("personal-factor");
    const [deleteRequest] = useDelete("personal-factor");
