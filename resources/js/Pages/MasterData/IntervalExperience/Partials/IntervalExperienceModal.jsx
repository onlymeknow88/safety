...
export default function IntervalExperienceModal({ visible, onCancel, onFinish, loading, initialValues }) {
    ...
    return (
        <Modal title={initialValues ? "Edit Interval Pengalaman" : "Tambah Interval Pengalaman"} open={visible} onCancel={onCancel} footer={null} destroyOnHidden>
            <Form form={form} layout="vertical" onFinish={onFinish} initialValues={{ is_active: true }}>
                <Form.Item label="Label Pengalaman" name="label" rules={[{ required: true, message: "Masukan label pengalaman!" }]}>
                    <Input placeholder="Contoh: 0 - 2 Tahun" />
                </Form.Item>
