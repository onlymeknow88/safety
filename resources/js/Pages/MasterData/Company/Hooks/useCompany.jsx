...
export default function useCompany() {
    ...
    const [postRequest, postFeedback] = usePost("company");
    const [putRequest, putFeedback] = usePut("company");
    const [deleteRequest, deleteFeedback] = useDelete("company");
    ...
    const fetchItems = useCallback(async (params = {}) => {
        try {
            ...
            notification.error({ message: "Gagal mengambil data Company" });
        }
    ...
    const handleConfirmDelete = async () => {
        ...
        try {
            ...
            if (response.data?.meta?.status === 'success') {
                notification.success({ message: "Data Company berhasil dihapus" });
