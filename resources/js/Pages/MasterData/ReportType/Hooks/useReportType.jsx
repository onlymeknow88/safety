...
export default function useReportType() {
    ...
    const [postRequest] = usePost("report-type");
    const [putRequest] = usePut("report-type");
    const [deleteRequest] = useDelete("report-type");
    ...
    const columns = useMemo(() => [
        { header: "KODE LAPORAN", accessorKey: "code", cell: ({ row }) => <span style={{ fontWeight: 600 }}>{row.original.code}</span> },
