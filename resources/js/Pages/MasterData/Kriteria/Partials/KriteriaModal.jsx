...
export default function KriteriaModal({ visible, onCancel, onFinish, loading, initialValues }) {
    ...
    return (
        <Modal title={initialValues ? "Edit Kriteria" : "Tambah Kriteria"} open={visible} onCancel={onCancel} footer={null} destroyOnHidden>
            <Form form={form} layout="vertical" onFinish={onFinish} initialValues={{ is_active: true }}>
                <Form.Item label="Nama Kriteria" name="name" rules={[{ required: true, message: "Masukan nama kriteria!" }]}>
                    <Input placeholder="Contoh: Sangat Berat" />
                </Form.Item>
