    ...
    return (
        <DashboardLayout title="Master Data Kriteria">
                ...
                <Row gutter={[16, 16]} align="middle" style={{ marginBottom: 24 }}>
                    <Col xs={24} md={12}>
                        ...
                        <p style={{ margin: 0, color: "#64748b", fontSize: isMobile ? "13px" : "14px" }}>
                            Kelola kriteria evaluasi dan klasifikasi data.
                        </p>
                    </Col>
            ...
            <DeleteConfirmModal
                ...
                description={`Apakah Anda yakin ingin menghapus kriteria "${itemToDelete?.name}"? Tindakan ini tidak dapat dibatalkan.`}
                loading={loading}
            />
        </DashboardLayout>
    );
