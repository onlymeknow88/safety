...
export default function DayModal({ visible, onCancel, onFinish, loading, initialValues }) {
    ...
    return (
        <Modal title={initialValues ? "Edit Hari" : "Tambah Hari Baru"} open={visible} onCancel={onCancel} footer={null} destroyOnHidden>
            <Form form={form} layout="vertical" onFinish={onFinish} initialValues={{ is_active: true }}>
                <Form.Item label="Nama Hari" name="name" rules={[{ required: true, message: "Masukan nama hari!" }]}>
                    <Input placeholder="Contoh: Senin" />
                </Form.Item>
