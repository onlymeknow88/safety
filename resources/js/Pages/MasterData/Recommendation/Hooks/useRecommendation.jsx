...
export default function useRecommendation() {
    ...
    const [postRequest] = usePost("recommendation");
    const [putRequest] = usePut("recommendation");
    const [deleteRequest] = useDelete("recommendation");
    ...
    const columns = useMemo(() => [
        { header: "NAMA REKOMENDASI", accessorKey: "name", cell: ({ row }) => <span style={{ fontWeight: 600 }}>{row.original.name}</span> },
