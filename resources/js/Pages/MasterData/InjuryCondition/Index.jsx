...
export default function InjuryConditionIndex() {
    ...
    return (
        <DashboardLayout title="Master Data Kondisi Luka">
            <Head title="Master Data Kondisi Luka" />
                ...
                <Row gutter={[16, 16]} align="middle" style={{ marginBottom: 24 }}>
                    <Col xs={24} md={12}>
                        <h2 style={{ margin: 0, fontWeight: 700, fontSize: isMobile ? "20px" : "24px", color: isDarkMode ? "#fff" : "#1e293b" }}>
                            Master Data Kondisi Luka
                        </h2>
                        <p style={{ margin: 0, color: "#64748b", fontSize: isMobile ? "13px" : "14px" }}>
                            Kelola data referensi kondisi luka/cedera.
                        </p>
                    </Col>
            ...
            <DeleteConfirmModal
                ...
                title="Hapus Kondisi Luka"
                description={`Apakah Anda yakin ingin menghapus kondisi luka "${itemToDelete?.name}"? Tindakan ini tidak dapat dibatalkan.`}
                loading={loading}
            />
        </DashboardLayout>
    );
