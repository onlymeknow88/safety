...
export default function useIncidentType() {
    ...
    const [postRequest] = usePost("incident-type");
    const [putRequest] = usePut("incident-type");
    const [deleteRequest] = useDelete("incident-type");
    ...
    const columns = useMemo(() => [
        { header: "KATEGORI", accessorKey: "category", cell: ({ row }) => <span style={{ fontWeight: 600 }}>{row.original.category}</span> },
