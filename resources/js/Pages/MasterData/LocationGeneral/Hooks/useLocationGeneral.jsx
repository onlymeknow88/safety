...
export default function useLocationGeneral() {
    const { notification } = App.useApp();
    const [getRequest, getFeedback] = useGet();
    const [postRequest] = usePost("location-general");
    const [putRequest] = usePut("location-general");
    const [deleteRequest] = useDelete("location-general");
