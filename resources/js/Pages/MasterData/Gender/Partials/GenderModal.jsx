...
export default function GenderModal({ visible, onCancel, onFinish, loading, initialValues }) {
    ...
    return (
        <Modal title={initialValues ? "Edit Jenis Kelamin" : "Tambah Jenis Kelamin"} open={visible} onCancel={onCancel} footer={null} destroyOnHidden>
            <Form form={form} layout="vertical" onFinish={onFinish} initialValues={{ is_active: true }}>
                <Form.Item label="Jenis Kelamin" name="name" rules={[{ required: true, message: "Masukan jenis kelamin!" }]}>
