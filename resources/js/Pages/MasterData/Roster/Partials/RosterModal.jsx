...
export default function RosterModal({ visible, onCancel, onFinish, loading, initialValues }) {
    ...
    return (
        <Modal title={initialValues ? "Edit Roster" : "Tambah Roster Baru"} open={visible} onCancel={onCancel} footer={null} destroyOnHidden>
            <Form form={form} layout="vertical" onFinish={onFinish} initialValues={{ is_active: true }}>
                <Form.Item label="Pola Roster" name="pattern" rules={[{ required: true, message: "Masukan pola roster!" }]}>
                    <Input placeholder="Contoh: 14:7" />
                </Form.Item>
