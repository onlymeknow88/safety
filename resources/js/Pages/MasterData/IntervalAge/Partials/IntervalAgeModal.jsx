...
export default function IntervalAgeModal({ visible, onCancel, onFinish, loading, initialValues }) {
    ...
    return (
        <Modal title={initialValues ? "Edit Interval Usia" : "Tambah Interval Usia"} open={visible} onCancel={onCancel} footer={null} destroyOnHidden>
            <Form form={form} layout="vertical" onFinish={onFinish} initialValues={{ is_active: true }}>
                <Form.Item label="Label Usia" name="label" rules={[{ required: true, message: "Masukan label usia!" }]}>
                    <Input placeholder="Contoh: 20 - 30 Tahun" />
                </Form.Item>
