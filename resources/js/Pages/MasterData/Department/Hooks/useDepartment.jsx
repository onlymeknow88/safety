...
export default function useCompany() {
    ...
    const [postRequest, postFeedback] = usePost("department");
    const [putRequest, putFeedback] = usePut("department");
    const [deleteRequest, deleteFeedback] = useDelete("department");
    ...
    const fetchItems = useCallback(async (params = {}) => {
        try {
            ...
            notification.error({ message: "Gagal mengambil data Department" });
        }
    ...
    const handleConfirmDelete = async () => {
        ...
        try {
            ...
            if (response.data?.meta?.status === 'success') {
                notification.success({ message: "Data Department berhasil dihapus" });
