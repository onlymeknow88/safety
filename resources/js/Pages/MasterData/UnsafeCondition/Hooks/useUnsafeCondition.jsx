...
export default function useUnsafeCondition() {
    const { notification } = App.useApp();
    const [getRequest, getFeedback] = useGet();
    const [postRequest] = usePost("unsafe-condition");
    const [putRequest] = usePut("unsafe-condition");
    const [deleteRequest] = useDelete("unsafe-condition");
