        ...
        <div style={{ marginBottom: 24 }}>
            <div style={{
                ...
                <Space size={16}>
                    ...
                    />
                    <Dropdown menu={{ items: columnItems }} trigger={['click']} placement="bottomRight" open={columnsVisible} onOpenChange={setColumnsVisible}>
                ...
                <Button type="primary" icon={<PlusOutlined />} onClick={onAddClick} style={{ height: 40, borderRadius: 10, fontWeight: 600 }}>Tambah Shift</Button>
            </div>
        </div>
    );
}
