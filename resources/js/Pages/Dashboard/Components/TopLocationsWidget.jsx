    ...
    return (
        <Card
            title={
                <span style={{ fontWeight: 800, fontSize: 14, color: labelColor, textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                    <EnvironmentOutlined style={{ marginRight: 8, color: '#ef4444' }} />
                    TOP 5 LOKASI INSIDEN
                </span>
            }
            style={{
                background: cardBg,
        ...
        >
            {data.length > 0 ? (
                            ...
                            <div key={idx} style={{ width: '100%' }}>
                                ...
                                <div style={{
                                    ...
                                    <div style={{
                                        width: `${pct}%`,
                                        height: '100%',
                                        background: `linear-gradient(90deg, #3b82f6 0%, ${barFillColor} 100%)`,
                                        borderRadius: 5,
                ...
                <Empty description="Belum ada data lokasi" style={{ paddingTop: 80 }} />
            )}
        </Card>
    );
}
