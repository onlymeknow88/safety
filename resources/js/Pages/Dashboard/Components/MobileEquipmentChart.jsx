            ...
            <div style={{ height: 320, position: 'relative' }}>
                {data.length > 0 ? (
                    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', justifyContent: 'space-between', alignItems: 'center' }}>
                        ...
                        <div style={{ position: 'relative', width: 180, height: 180, margin: '5px auto' }}>
                            ...
                            <div style={{
                                ...
                                <div style={{ fontSize: 28, fontWeight: 900, color: labelColor, lineHeight: 1 }}>
                                    {total}
                                </div>
                                <div style={{ fontSize: 9, fontWeight: 800, color: secondaryTextColor, letterSpacing: '0.1em', marginTop: 4 }}>
                                    TOTAL CASE
                                </div>
                            </div>
                        </div>
                        ...
                        <div style={{
                            ...
                            {data.map((item, index) => {
                                ...
                                return (
                                    <div key={index} style={{ display: 'flex', alignItems: 'flex-start', gap: 6, minWidth: 90 }}>
                                        <div style={{ width: 8, height: 8, borderRadius: '50%', background: color, marginTop: 4 }} />
                                        <div>
                                            <div style={{ fontSize: 11, fontWeight: 700, color: labelColor, whiteSpace: 'nowrap', textOverflow: 'ellipsis', overflow: 'hidden', maxWidth: 100 }}>
