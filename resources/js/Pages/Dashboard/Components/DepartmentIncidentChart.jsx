...
export default function DepartmentIncidentChart({ data = [], isDarkMode }) {
                ...
                if (!meta.hidden) {
                    meta.data.forEach((point, index) => {
                        ...
                        if (value > 0) {
                            ...
                            const y = point.y - 17; // Position above the dot
