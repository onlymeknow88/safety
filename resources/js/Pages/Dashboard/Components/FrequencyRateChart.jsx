...
export default function FrequencyRateChart({ data = [], isDarkMode }) {
    ...
    const values = data.map(item => item.fr);
    ...
    const chartData = {
        ...
        datasets: [{
            label: 'FR',
            data: values,
            backgroundColor: '#2563eb', // Clean solid blue
            borderRadius: 8,
